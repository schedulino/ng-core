...
describe('AbstractModel', () => {
    ...
    let abstractResource, abstractModel, route = 'test', id = '1', item = {id: id, test: 'test', updated: 'updated'}, collection = [item];
    ...
    itAsync('should update item in collection', () => {
        const respond = {updated: 'updated-updated'};
        ...
        return abstractModel.save(itemUpdated).then(() => {
            expect(abstractModel.getCollection()[1].updated).toEqual(respond.updated);
    ...
    itAsync('should create item and push item to collection with new id and updated properties', () => {
        ...
        return abstractModel.save(newItem).then(() => {
            ...
            expect(abstractModel.getCollection()[0].updated).toEqual(item.updated);
